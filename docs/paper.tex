...
While our analytical estimate predicts $S \approx 39$ Gpc, systematic numerical exploration reveals optimal matches at $S = 15$-65 Gpc, with the best balance of size and expansion rate R$^2$ occurring at $S = 20$ Gpc.
...
\begin{itemize}
    ...
    \item Reproduction of $\Lambda$CDM expansion dynamics to $> 99\%$ endpoint accuracy with $R^2 > 0.81$ for expansion rate evolution
...
Through N-body simulations, we have demonstrated that multiple parameter configurations (M = 69-97000 $\times$ M$_{obs}$, S = 15-65 Gpc) reproduce $\Lambda$CDM expansion dynamics with $>99\%$ endpoint accuracy and R$^2 > 0.81$ for expansion rate evolution.
