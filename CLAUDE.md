...
• The Lode is for YOU (the AI). Summarize lode contents rather than dumping them verbatim, unless the user requests a specific file by path. Sacrifice grammar for the sake of concision, but add line breaks when it makes sense to make diffs better.
