...
- [plans/node-geometries.md](./plans/node-geometries.md) - WS3: node-geometry factory (cube26/dense/shell/fcc) threaded through HMEAGrid+sweep+anisotropy; vacuum-traceless honesty. IMPLEMENTED: cosmo/node_geometry.py + 53 passing tests.
