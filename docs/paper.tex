...
Beyond the expansion match, the same discrete lattice geometry---with no additional free parameters---generates predictions consistent with three independent large-scale anomalies: the Hubble Tension ($\Delta H_0/H_0 \approx 5$-$11\%$ \cite{Riess2021}), the CMB ``Axis of Evil'' \cite{Land2005}, and large-scale ``dark flow'' \cite{Watkins2023}.
...
We compute the total effective equation of state parameter using $w_{eff} = -1 - (2/3) \cdot d(\ln H)/d(\ln a)$, which characterizes the net deceleration parameter of the expansion rather than the dark energy component alone.
...
This anisotropy may contribute to the observed ``Hubble Tension''---the $\sim$8.6\% discrepancy between early-universe (CMB-calibrated, $\sim$67 km/s/Mpc) and late-universe (distance ladder, $\sim$73 km/s/Mpc) measurements of $H_0$ \cite{Riess2021, DiValentino2021}.
