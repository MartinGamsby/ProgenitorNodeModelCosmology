...
The irregular (virialized) nature of the meta-structure produces a dipole anisotropy in the Hubble constant of $\Delta H_0/H_0 \approx 5$-$11\%$, comparable to the observed Hubble Tension ($\sim$8.6\%) \cite{Riess2021}.
...
\begin{itemize}
    \item Position irregularity only (5\%): $\Delta H_0 / H_0 \approx 2.8\%$ (grid average)
    \item Mass variation only (20\%): $\Delta H_0 / H_0 \approx 3.7\%$ (grid average)
    \item \textbf{Combined (position + mass)}: $\Delta H_0 / H_0 \approx 4.7\%$ ($\sim$3.3 km/s/Mpc, grid average)
    \item \textbf{Single nearest node (worst case)}: $\Delta H_0 / H_0 \approx 11.4\%$ ($\sim$8.0 km/s/Mpc)
    \item Observed Hubble Tension: $\sim$8.6\% (6 km/s/Mpc difference between 67 and 73 km/s/Mpc)
\end{itemize}

\paragraph{Implications:}
The predicted dipole ($\sim$4.7\% grid average, up to $\sim$11.4\% worst-case) is comparable to the Hubble Tension ($\sim$8.6\%).
...
The predicted $H_0$ dipole of $\Delta H_0/H_0 \approx 4.7\%$ (Section 7.2) corresponds to an asymmetric acceleration that, integrated over cosmic time, produces bulk velocities of order:
\[
v_{bulk} \sim \frac{\Delta H_0}{H_0} \times H_0 \times R_{eff} \approx 0.047 \times 70 \text{ km/s/Mpc} \times 100 \text{ Mpc} \approx 330 \text{ km/s}
\]
This is consistent with the observed $\sim$400 km/s---reasonable given the simplified analytical estimate. The single nearest-node scenario ($\Delta H_0/H_0 \approx 11.4\%$) would yield $\sim$800 km/s, bracketing the observed value.
