...
\]
where $R_{eff} \sim 100$ Mpc is a characteristic scale for bulk flow measurements, chosen to match the effective depth at which peculiar velocity surveys are most sensitive \cite{Watkins2023}.
